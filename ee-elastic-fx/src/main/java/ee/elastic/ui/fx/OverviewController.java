...
public class OverviewController {
	...
	public OverviewController(Stage stage, Model model, TableView<Map<String, Object>> indicesTable,
			ListView<String> detailsTypes, AnchorPane detailsTypeMapping, AnchorPane detailsStatus,
			AnchorPane detailsMetadata) {
		super();
		this.model = model;
