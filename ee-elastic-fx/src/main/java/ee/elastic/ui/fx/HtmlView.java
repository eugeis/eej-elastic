...
public class HtmlView<E> extends BaseView<WebView, E> {
	...
	public void data(E data) {
		...
		Element head = templates.head().addChild(
				templates.style().content(cssContent));
