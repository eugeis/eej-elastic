...
public class Model {
  ...
  public SearchResponse search() {
    System.out.println();
    SearchRequestBuilder requestBuilder = elasticSearchClient.client().prepareSearch(searchIndices.toArray(new String[0])).setTypes(searchTypes.toArray(new String[0])).addFields("_source", "_parent").setSearchType(SearchType.DFS_QUERY_THEN_FETCH).setFrom(0).setSize(rowCount).setExplain(false);
